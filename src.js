...
var ReaderMinimumAdvantage = 15;
var ArticleMinimumScoreDensity = 4.25;
var BlacklistedHostsAllowedPathPrefixesMap = {};
BlacklistedHostsAllowedPathPrefixesMap["www.apple.com"] = ["/pr/"];
var CandidateMinimumWidth = 280;
var CandidateMinimumHeight = 295;
var CandidateMinimumArea = 170000;
var CandidateMaximumTop = 1300;
var CandidateMinimumWidthPortionForIndicatorElements = 0.5;
var CandidateMinumumListItemLineCount = 4;
var CandidateTagNamesToIgnore = {
    "A": 1,
    "BODY": 1,
    "EMBED": 1,
    "FORM": 1,
...
var CandidateTagNamesToIgnoreDescendantsOf = {
    "DD": 1,
    "DT": 1,
    "LI": 1,
    "OL": 1,
...
var PrependedArticleCandidateMinimumHeight = 50;
var AppendedArticleCandidateMinimumHeight = 200;
var AppendedArticleCandidateMaximumVerticalDistanceFromArticle = 150;
var StylisticClassNames = {
    "justfy": 1,
    "justify": 1,
    "left": 1,
    "right": 1,
...
var CommentRegEx = /comment|meta|footer|footnote/;
var CommentMatchPenalty = 0.5;
var ArticleRegEx = /(?:(?:^|\\s)(?:post|hentry|entry[-]?(?:content|text|body)?|article[-]?(?:content|text|body)?)(?:\\s|$))/;
var ArticleMatchBonus = 0.5;
var DensityExcludedElementSelector = "#disqus_thread, #comments, .userComments";
var AttributesToRemoveRegEx = /^on|^id$|^class$|^style$/;
var PositiveRegEx = /article|body|content|entry|hentry|page|pagination|post|text/i;
...
var MinimumAverageDistanceBetweenHRElements = 400;
var MinimumAverageDistanceBetweenHeaderElements = 400;
var PortionOfCandidateHeightToIgnoreForHeaderCheck = 0.1;
var ScoreMultiplierForChineseJapaneseKorean = 3;
var MinimumContentImageHeight = 200;
var MinimumContentImageWidthToArticleWidthRatio = 0.5;
var MaximumContentImageAreaToArticleAreaRatio = 0.2;
var LinkContinueMatchRegEx = /continue/gi;
var LinkNextMatchRegEx = /next/gi;
var LinkPageMatchRegEx = /page/gi;
var LinkListItemBonus = 5;
var LinkPageMatchBonus = 10;
var LinkNextMatchBonus = 15;
var LinkContinueMatchBonus = 15;
var LinkNextOrdinalValueBase = 3;
var LinkMismatchValueBase = 2;
var LinkMatchWeight = 200;
var LinkMaxVerticalDistanceFromArticle = 200;
var LinkVerticalDistanceFromArticleWeight = 150;
var LinkCandidateXPathQuery = "descendant-or-self::*[(not(@id) or (@id!='disqus_thread' and @id!='comments')) and (not(@class) or @class!='userComments')]/a";
var LinkDateRegex = /\D(?:\d\d(?:\d\d)?[\-\/](?:10|11|12|0?[1-9])[\-\/](?:30|31|[12][0-9]|0?[1-9])|\d\d(?:\d\d)?\/(?:10|11|12|0[1-9])|(?:10|11|12|0?[1-9])\-(?:30|31|[12][0-9]|0?[1-9])\-\d\d(?:\d\d)?|(?:30|31|[12][0-9]|0?[1-9])\-(?:10|11|12|0?[1-9])\-\d\d(?:\d\d)?)\D/;
var LinkURLSearchParameterKeyMatchRegex = /(page|^p$|^pg$)/i;
var LinkURLPageSlashNumberMatchRegex = /\/.*page.*\/\d+/i;
var LinkURLSlashDigitEndMatchRegex = /\/\d+\/?$/;
var LinkURLArchiveSlashDigitEndMatchRegex = /archives?\/\d+\/?$/;
var LinkURLBadSearchParameterKeyMatchRegex = /feed/;
var LinkURLSemanticMatchBonus = 100;
var LinkMinimumURLSimilarityRatio = 0.75;
var HeaderMinimumDistanceFromArticleTop = 200;
var HeaderLevenshteinDistanceToLengthRatio = 0.75;
var FloatMinimumHeight = 130;
var ImageSizeTiny = 32;
var ImageWidthToParentWidthRatio = .5;
var AnchorImageMinimumWidth = 100;
var AnchorImageMinimumHeight = 100;
var BaseFontSize = 16;
var BaseLineHeightRatio = 1.125;
var MaximumExactIntegralValue = 9007199254740992;
var TitleCandidateDepthScoreMultiplier = 0.1;
var DocumentPositionDisconnected = 0x01;
var DocumentPositionPreceding = 0x02;
var DocumentPositionFollowing = 0x04;
var DocumentPositionContains = 0x08;
var DocumentPositionContainedBy = 0x10;
...
CandidateElement.extraArticleCandidateIfElementIsViable = function extraArticleCandidateIfElementIsViable(element, selectedArticle, contentDocument, isPrepended) {
    var InlineTextContainerTagNames = "a, b, strong, i, em, u, span";
...
CandidateElement.prototype = {
    ...
    rawScoreForTextNode: function rawScoreForTextNode(textNode) {
        var TextNodeMinimumLength = 20;
        var TextNodeLengthPower = 1.25;
        if (!textNode)
            return 0;
...
ReaderArticleFinder.prototype = {
    ...
    shouldPruneElement: function shouldPruneElement(element, originalElement) {
        var MaxInputToParagraphRatio = 0.33;
        var MaxPositiveWeightLinkDensity = 0.5;
        var MaxStandardLinkDensity = 0.2;
        var MinimumTextLength = 25;
        var MinimumAverageImageArea = 200 * 200;
        ...
        if (element.tagName === "OBJECT") {
            var PlugInsToKeepRegEx = /youtube|vimeo|dailymotion/;
    ...
    adoptableLeadingImage: function adoptableLeadingImage() {
        var LeadingImageMaximumContainerChildren = 5;
        var LeadingImageMinimumAbsoluteWidth = 600;
        var LeadingImageCreditRegex = /credit/;
        var LeadingImageCaptionRegex = /caption/;
        var LeadingImageAttributeToKeepRegex = /src|alt/;
    ...
    cleanArticleNode: function cleanArticleNode(originalArticleNode, clonedArticleNode, allowedToReturnNull) {
        ...
        var tagNamesAffectingFontStyle = {
            "I": 1,
            "EM": 1
        };
        var tagNamesAffectingFontWeight = {
            "B": 1,
            "STRONG": 1,
            "H1": 1,
            "H2": 1,
        ...
        var MaximumFloatingContentRatio = 0.8;
    ...
    leadingImageNode: function leadingImageNode() {
        var LeadingImageMinimumHeight = 250;
        var LeadingImageMinimumWidthRatio = 0.5;
        var LeadingImageNumberOfAncestorsToSearch = 3;
    ...
    articleTitle: function articleTitle() {
        ...
        var HeaderMaximumDistance = 500;
        var HeaderMinimumTextLength = 8;
        var HeaderMinimumFontSize = 12;
        var HeaderFontSizeBonusMinimumRatio = 1.1;
        var HeaderFontSizeBonusMultiplier = 1.25;
        var HeaderBonusRegEx = /header|title|headline/i;
        var HeaderRegexBonusMultiplier = 1.5;
        var HeaderContentBonusMultiplier = 1.5;
        var HeaderMaximumDOMDistance = 9;
        var HeaderMinimumFontSizeDifference = 1.5;
    ...
    findCandidateElements: function findCandidateElements() {
        var MaximumCandidateDetectionTimeInterval = 1000;
    ...
    readingListItemInformation: function readingListItemInformation() {
        var ReaderTitleMaxLength = 140;
        var ReaderPreviewTextMaxLength = 140;
        var title;
        var previewText;
